...
export const metadata: Metadata = {
  title: "Weather Arbitrage",
  alternates: { canonical: "/weather-arb" },
};
import {
  Button,
  Card,
      ...
      <section className="py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-16">
            ...
            <p className="text-sm text-surface-600 mb-8">Moderate scenario &mdash; 50&ndash;100% monthly return range</p>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody className="font-mono">
                  {[
                    { capital: "$50", low: "+$25", high: "+$50", trades: "3\u20135", maxPos: "$10" },
                    { capital: "$100", low: "+$50", high: "+$100", trades: "4\u20136", maxPos: "$20" },
                    { capital: "$250", low: "+$125", high: "+$250", trades: "5\u20138", maxPos: "$50" },
                    { capital: "$500", low: "+$250", high: "+$500", trades: "5\u20138", maxPos: "$100" },
                    { capital: "$1,000", low: "+$500", high: "+$1,000", trades: "6\u201310", maxPos: "$200" },
                    { capital: "$5,000", low: "+$2,500", high: "+$5,000", trades: "8\u201312", maxPos: "$1,000" },
                  ].map((row) => (
            ...
            <div className="mt-8 space-y-3">
              {[
                { capital: "$50", range: "+$25\u2013$50", width: "5%" },
                { capital: "$100", range: "+$50\u2013$100", width: "10%" },
                { capital: "$250", range: "+$125\u2013$250", width: "25%" },
                { capital: "$500", range: "+$250\u2013$500", width: "50%" },
                { capital: "$1K", range: "+$500\u2013$1K", width: "75%" },
                { capital: "$5K", range: "+$2.5K\u2013$5K", width: "100%" },
              ].map((bar) => (
