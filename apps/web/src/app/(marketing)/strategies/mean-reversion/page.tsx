      ...
      <section className="border-y border-surface-300 bg-surface-50 py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-16">
            ...
            <p className="text-sm text-surface-600 mb-8">Moderate scenario &mdash; 15&ndash;30% monthly return range</p>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody className="font-mono">
                  {[
                    { capital: "$50", low: "+$8", high: "+$15", trades: "2\u20134", maxPos: "$10" },
                    { capital: "$100", low: "+$15", high: "+$30", trades: "3\u20135", maxPos: "$20" },
                    { capital: "$250", low: "+$38", high: "+$75", trades: "3\u20136", maxPos: "$50" },
                    { capital: "$500", low: "+$75", high: "+$150", trades: "3\u20136", maxPos: "$100" },
                    { capital: "$1,000", low: "+$150", high: "+$300", trades: "4\u20138", maxPos: "$200" },
                    { capital: "$5,000", low: "+$750", high: "+$1,500", trades: "5\u201310", maxPos: "$1,000" },
                  ].map((row) => (
            ...
            <div className="mt-8 space-y-3">
              {[
                { capital: "$50", range: "+$8\u2013$15", width: "5%" },
                { capital: "$100", range: "+$15\u2013$30", width: "10%" },
                { capital: "$250", range: "+$38\u2013$75", width: "25%" },
                { capital: "$500", range: "+$75\u2013$150", width: "50%" },
                { capital: "$1K", range: "+$150\u2013$300", width: "75%" },
                { capital: "$5K", range: "+$750\u2013$1.5K", width: "100%" },
              ].map((bar) => (
